...
st.sidebar.write("This is a web app to predict the Bike Rental Demand with just a few details.")
st.sidebar.title("Explore my notebooks 📖")
...
st.sidebar.write("➡️Check out [Part 2 - Data Preparation](https://nbviewer.jupyter.org/github/SarthakRana/Bike-Sharing-Demand-Prediction/blob/main/bike_sharing_data_preparation_Part2.ipynb)")
...
st.sidebar.title("You can follow ❤️ me on :")
